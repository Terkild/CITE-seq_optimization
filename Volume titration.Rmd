...
Samples stained in reduced volume have reduced ADT counts largely evenly distributed among cells
...
cowplot::ggdraw(plot_grid(ADE, BC, nrow=1, rel_widths=c(1,4), align="v", axis="l")) + cowplot::draw_plot(p2.legend,0.27,0.020,0.2,0.00001)
dev.off()
```
