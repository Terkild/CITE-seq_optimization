...
currentDir <- "C:/Users/mqh628/OneDrive - Københavns Universitet/Koralovlab/CITE-seq_titration"
t2g.file <- "D:/Projects/ECCITE-seq/TotalSeqC_TitrationA/kallisto/t2g_cellranger.txt"
kallistobusDir <- "D:/Projects/ECCITE-seq/TotalSeqC_TitrationA/kallisto/gex/c1/counts_unfiltered"
kallistobusDirADT <- "D:/Projects/ECCITE-seq/TotalSeqC_TitrationA/kallisto/features/A1_S5.ADT_15/counts_unfiltered"
kallistobusDirHTO <- "D:/Projects/ECCITE-seq/TotalSeqC_TitrationA/kallisto/features/H1_S6.HTO_A_13/counts_unfiltered"
setwd(currentDir)
...
Based on mitochondrial reads. Cutoff set to 15% by visual inspection.
...
#object = SetAssayData(object=object, assay="ADT.kallisto", slot="scale", new.data = normalized_matrix_individual)
